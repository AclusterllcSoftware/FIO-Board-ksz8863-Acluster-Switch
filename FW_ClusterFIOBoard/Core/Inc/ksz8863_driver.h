...
//Enum for power management modes

typedef enum {
  NORMAL_MODE = 0x00,
  ENERGY_DETECTION_MODE = 0x01,
  SOFTWARE_POWER_DOWN_MODE = 0x02,
  POWER_SAVING_MODE = 0x03
} PowerManagementMode;


// Enum for CPU interface clock selection
typedef enum {
  CLOCK_31_25_MHZ = 0x00, // 00 = 31.25 MHz supports SPI speed below 6 MHz
  CLOCK_62_5_MHZ  = 0x01, // 01 = 62.5 MHz supports SPI speed between 6 MHz to 12.5 MHz
  CLOCK_125_MHZ   = 0x02  // 10 = 125 MHz supports SPI speed above 12.5 MHz
} CpuClockSelection;
...
MacAddr ksz8863GetSwitchMacAddr();
